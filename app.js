...
// Check your work:
console.log('Exercise 1 my result: ', veryOldInventors); // this is my results
...
// Check your work:
console.log('Exercise 2 my result: ', inventorNames); // this is my results 
...
// Check your work:
console.log('Exercise 3 my result: ', sortedByBirthYear); /// this is my results
...
// Check your work:
console.log('Exercise 4 my result: ', inventorNamedAda); // this is my results
...
// Check your work:
console.log('Exercise 5 my result: ', firstLast); // this is my results
...
let isEveryone19OrOlder = devs.every(dev => 2015 - dev.year >= 19);

// Check your work:
console.log('Exercise 7 my result: ', isEveryone19OrOlder); // my results
...
// Check your work:
console.log('Exercise 8 my result: ', commentById); // my results
...
// Check your work:
console.log('Exercise 9 my result: ', idx); // my results
